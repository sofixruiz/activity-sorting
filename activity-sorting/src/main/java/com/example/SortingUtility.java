...
public class SortingUtility {
    ...
    private static <T extends Comparable<T>> int partition(T[] data, int min, int max) {
        ...
        while (left < right) {
            ...
            // search for an element that is < the partition elements
        ...
        // move the partition elements back into place
        swap(data, min, right);
    ...
    private static <T extends Comparable<T>> void merge(T[] data, int first, int mid, int last) {
        ...
        /*
        Copy smaller items frm each subarray into temp until one of the subarrays is exhausted
         */
